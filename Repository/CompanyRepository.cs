using Dapper;
using DapperDotNetCoreApi.Context;
using DapperDotNetCoreApi.Contracts;
using DapperDotNetCoreApi.Dto;
using DapperDotNetCoreApi.Entities;
using System.Data;

namespace DapperDotNetCoreApi.Repository
{
